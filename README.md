...
<p align="center">
  <img src="docs/screenshots/macos/v3.20/board.png" width="620" alt="게임 보드">
</p>
...
- **데일리 딜 / 데일리 챌린지**: 날짜 기반 고정 시드 — 매일 새로운 딜, 별점(승리·시간·이동 수) 3점
...
- 단위 테스트 220개 통과 (딜 재현 · 이동 규칙 · 수퍼무브 용량 · 승리 판정 · 저장/복원 · 데일리/챌린지/업적 · Winnable 솔버)
