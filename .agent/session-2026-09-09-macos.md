...
- 남은 TODO: **보류만 남음** — T-206(솔버 휴리스틱), T-030(변형 프리셀 추가). 그 외 전부 완료.
- 전달 로그: **GUI 라이브 검증 전체 완료 (2026-09-09)** — 사용자 "잘 됨". 피라미드 재활용 1회·스파이더 스톡 더미 소진·변형별 탭/드래그(FreeCell/Klondike/Forty Thieves/Golf/TriPeaks/Yukon/Scorpion/Spider/Sea Tower/Super FreeCell) 확인. T-243 수동 시나리오·T-058/T-068 수동 검증도 함께 마무리. 배포 버전 상수 4곳 3.27.0으로 갱신 (커밋 e510893).
